					...
					if (!$_SESSION["loggedIn"]) {
						if ($confirmPassword != $password) {
							...
							if ($row != null) {
								...
								$query2 = "INSERT INTO Users (firstName,lastName,email,username,password,securityQuestion,securityAnswer,admin,accountStatus) VALUES ('" . $firstname . "','" . $lastname . "','" . $email . "','" . $username . "','" . password_hash($password, PASSWORD_DEFAULT) . "','" . $securityQuestion . "','" . $securityAnswer . "',0,'ACTIVE');";
								$PDO->exec($query2);
